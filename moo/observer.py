...
from moo.optigob_problem import build_json_config
import csv
    ...
    def update(self, *args, **kwargs):
        ...
        with open(pareto_file, "w") as file:
            ...
            for solution in pareto_front:
                writer.writerow([solution.objectives[0], solution.objectives[1], solution.objectives[2], solution.objectives[3], build_json_config(solution.variables)])